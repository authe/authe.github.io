...
\begin{tabular}{@{}p{0.20in}p{2.4in}p{2.75in}}
 & Financial Stability Department  &  Email:
...
\begin{list1}
\item[] Principal Researcher, Bank of Canada
\end{list1}
...
\begin{list1}
\item[] Senior Economist, Bank of Canada, August 2019 - March 2022
...
\begin{list1}
\item[] Artificial intelligence and financial crises (with Jon Danielsson), \textit{Journal of Financial Stability}, 101453, 2025.
\vspace*{0.2cm}
...
\vspace*{0.2cm}
\item[] Central Bank Crisis Interventions and the Term Structure of Market Fear (with Mattia Bevilacqua, Jon Danielsson, Lerby Ergun,  and Jean-Pierre Zigrand), R\&R at the \textit{Journal of Money, Credit \& Banking}.
\vspace*{0.2cm}
...
\begin{list1}
\item[] Economica, Journal of the European Economic Association, Journal of Banking \& Finance, Journal of Financial Stability, Journal of Money, Credit \& Banking, Macroeconomic Dynamics, North American Journal of Economics \& Finance, Review of Economic Studies, Scandinavian Journal of Economics
\end{list1}
